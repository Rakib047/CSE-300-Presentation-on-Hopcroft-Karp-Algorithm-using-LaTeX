...
\author[Rakib,Sany,Bijoy]{Rakib Abdullah-1905047\\Al-Amin Sany-1905048\\Bijoy Saem-1905052}
...
After running the DFS on the remaining part, $$M=\{A-E,C-F,G-D\}$$ \\
\vspace{.35cm}
\hspace{2.7cm}
    \begin{tikzpicture}[scale=1.5]
\tikzset{vertex/.style = {shape=circle,draw,minimum size=1.5em}}

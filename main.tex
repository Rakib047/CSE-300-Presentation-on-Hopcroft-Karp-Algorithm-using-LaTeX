...
\begin{frame}{Second iteration:BFS}
    ...
    \only<3>{$\hspace{3cm}\text{Augmenting path}=b->e->a->h$}\\
    \vspace{.5cm}
\hspace{2.7cm}
    \begin{tikzpicture}[scale=1.5]
\tikzset{vertex/.style = {shape=circle,draw,minimum size=1.5em}}
